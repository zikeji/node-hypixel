...
import { FindGuild } from "./methods/findGuild.ts";
import { Friends } from "./methods/friends.ts";
import { Guild } from "./methods/guild.ts";
import { Player } from "./methods/player.ts";
import { RecentGames } from "./methods/recentGames.ts";
import { Resources } from "./methods/resources/index.ts";
import { SkyBlock } from "./methods/skyblock/index.ts";
import { Status } from "./methods/status.ts";
import type { Components, Paths } from "./types/api.ts";
